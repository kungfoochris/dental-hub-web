      ...
      def get(self, request, format=None):
            if CustomUser.objects.select_related('role').filter(id=request.user.id,role__name='warduser').exists():
                ...
                for i in customuser_obj.location.all():
                    ...
                    total_sdf_adult = Visualization.objects.filter(geography_id=i.id,sdf=True,age__range=[60,18]).count()
                    ...
                    total_seal_adult = Visualization.objects.filter(geography_id=i.id,seal=True,age__range=[60,18]).count()
                    ...
                    total_art_adult = Visualization.objects.filter(geography_id=i.id,art=True,age__range=[60,18]).count()
                    ...
                    total_exo_adult = Visualization.objects.filter(geography_id=i.id,exo=True,age__range=[60,18]).count()
