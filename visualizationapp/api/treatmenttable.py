        ...
        if serializer.is_valid():
            ...
            if not location_list:
                ...
                for location in location_list:
                    treatment_male_list.append(Visualization.objects.filter(gender='male',created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    treatment_female_list.append(Visualization.objects.filter(gender='female',created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    treatment_child_list.append(Visualization.objects.filter(age__lt=18,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    treatment_adult_lits.append(Visualization.objects.filter(age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    treatment_old_list.append(Visualization.objects.filter(age__gt=60,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())

                    total_fv_list.append(Visualization.objects.filter(fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    female_patients_receiving_fv_list.append(Visualization.objects.filter(gender='female',fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    male_patients_receiving_fv_list.append(Visualization.objects.filter(gender='male',fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    child__patients_receiving_fv_list.append(Visualization.objects.filter(age__lt=18,fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    adult__patients_receiving_fv_list.append(Visualization.objects.filter(age__range=(18,60),fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    old__patients_receiving_fv_list.append(Visualization.objects.filter(age__gt=60,fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())


                    total_need_sealant_list.append(Visualization.objects.filter(need_sealant=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    sealant_male_list.append(Visualization.objects.filter(gender='male',need_sealant=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    sealant_female_list.append(Visualization.objects.filter(gender='female',need_sealant=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    sealant_child_list.append(Visualization.objects.filter(age__lt=18,need_sealant=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    sealant_adult_list.append(Visualization.objects.filter(age__range=(18, 60),need_sealant=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    sealant_old_list.append(Visualization.objects.filter(age__gt=60,need_sealant=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                ...
                female_patients_receiving_fv = sum(female_patients_receiving_fv_list)
                male_patients_receiving_fv = sum(male_patients_receiving_fv_list)
                child__patients_receiving_fv = sum(child__patients_receiving_fv_list)
                adult__patients_receiving_fv = sum(adult__patients_receiving_fv_list)
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if not location_list:
                ...
                for location in location_list:
                    encounter_male.append(Visualization.objects.filter(gender='male',created_at__range=[start_date,end_date],geography_id=location.id).values('encounter_id').annotate(Count('encounter_id')).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    encounter_female.append(Visualization.objects.filter(gender='female',created_at__range=[start_date,end_date],geography_id=location.id).values('encounter_id').annotate(Count('encounter_id')).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    encounter_child.append(Visualization.objects.filter(age__lt=18,created_at__range=[start_date,end_date],geography_id=location.id).values('encounter_id').annotate(Count('encounter_id')).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    encounter_adult.append(Visualization.objects.filter(age__range=(18, 60),created_at__range=[start_date,end_date],geography_id=location.id).values('encounter_id').annotate(Count('encounter_id')).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    encounter_old.append(Visualization.objects.filter(age__gt=60,created_at__range=[start_date,end_date],geography_id=location.id).values('encounter_id').annotate(Count('encounter_id')).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())

                    refer_male.append(Visualization.objects.filter(gender='male',refer_hp=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    refer_female.append(Visualization.objects.filter(gender='female',refer_hp=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    refer_child.append(Visualization.objects.filter(age__lt=18,refer_hp=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    refer_adult.append(Visualization.objects.filter(age__range=(18,60),refer_hp=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    refer_old.append(Visualization.objects.filter(age__gt=60,refer_hp=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_refer.append(Visualization.objects.filter(refer_hp=True,created_at__range=[start_date,end_date],geography_id=location.id).count())

                    total_seal_male.append(Visualization.objects.filter(gender='male',seal=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    print("----------")
                    print(Visualization.objects.filter(gender='male',seal=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_seal_female.append(Visualization.objects.filter(gender='female',seal=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_seal_child.append(Visualization.objects.filter(age__lt=18,seal=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_seal_adult.append(Visualization.objects.filter(age__range=(18,60),seal=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_seal_old.append(Visualization.objects.filter(age__gt=60,seal=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())

                    totalfv_male.append(Visualization.objects.filter(gender='male',fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    print("******************")
                    print(Visualization.objects.filter(gender='male',fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    totalfv_female.append(Visualization.objects.filter(gender='female',fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    totalfv_child.append(Visualization.objects.filter(age__lt=18,fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    totalfv_adult.append(Visualization.objects.filter(age__range=(18,60),fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    totalfv_adult.append(Visualization.objects.filter(age__gt=60,fv=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())

                    total_exo_male.append(Visualization.objects.filter(gender='male',exo=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_exo_female.append(Visualization.objects.filter(gender='female',exo=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_exo_child.append(Visualization.objects.filter(age__lt=18,exo=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_exo_adult.append(Visualization.objects.filter(age__range=(18,60),exo=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_exo_old.append(Visualization.objects.filter(age__gt=60,exo=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())


                    total_art_male.append(Visualization.objects.filter(gender='male',art=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_art_female.append(Visualization.objects.filter(gender='female',art=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_art_child.append(Visualization.objects.filter(age__lt=18,art=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_art_adult.append(Visualization.objects.filter(age__range=(18,60),art=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_art_old.append(Visualization.objects.filter(age__gt=60,art=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())


                    total_sdf_male.append(Visualization.objects.filter(gender='male',sdf=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    print("+++++++++++++++++")
                    print(Visualization.objects.filter(gender='male',sdf=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_sdf_female.append(Visualization.objects.filter(gender='female',sdf=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_sdf_child.append(Visualization.objects.filter(age__lt=18,sdf=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_sdf_adult.append(Visualization.objects.filter(age__range=(18,60),sdf=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                    total_sdf_old.append(Visualization.objects.filter(age__gt=60,sdf=True,created_at__range=[start_date,end_date],geography_id=location.id).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count())
                ...
                try:
                    early_intervention_ratio_adult = (sum(total_art_adult)+sum(total_sdf_adult))/sum(total_exo_adult)
                except:
                    early_intervention_ratio_adult=0
