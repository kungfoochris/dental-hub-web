    ...
    def get(self, request,format=None):
        if User.objects.filter(id=request.user.id).exists():
            ...
            final_total_carries_risk_low = [
                ...
                str(carries_risk_low_number[0]) + "(" + str(total_carries_risk_low[0]) + "%)",
                str(carries_risk_low_number[1]) + "(" + str(total_carries_risk_low[1]) + "%)",
            ...
            final_total_carries_risk_medium = [
                ...
                str(carries_risk_medium_number[0]) + "(" + str(total_carries_risk_medium[0]) + "%)",
                str(carries_risk_medium_number[1]) + "(" + str(total_carries_risk_medium[1]) + "%)",
            ...
            final_total_carries_risk_high = [
                ...
                str(carries_risk_high_number[0]) + "(" + str(total_carries_risk_high[0]) + "%)",
                str(carries_risk_high_number[1]) + "(" + str(total_carries_risk_high[1]) + "%)",
            ...
            final_total_untreated_caries_present = [
                ...
                str(untreated_caries_present_number[0]) + "(" + str(total_untreated_caries_present[0]) + "%)",
                str(untreated_caries_present_number[1]) + "(" + str(total_untreated_caries_present[1]) + "%)",
            ...
            final_total_decayed_primary_teeth = [
                "Number of decayed primary teeth" ,
                str(decayed_primary_teeth_mean[0]) + "(" + str(total_decayed_primary_teeth[0]) + "SD)",
                str(decayed_primary_teeth_mean[1]) + "(" + str(total_decayed_primary_teeth[1]) + "SD)",
            ...
            final_total_decayed_permanent_teeth = [
                "Number of decayed permanent teeth" ,
                str(decayed_permanent_teeth_mean[0]) + "(" + str(total_decayed_permanent_teeth[0]) + "SD)",
                str(decayed_permanent_teeth_mean[1]) + "(" + str(total_decayed_permanent_teeth[1]) + "SD)",
            ...
            final_total_cavity_permanent_molar = [
                "Cavity permanent molar or premolar" ,
                str(cavity_permanent_molar_number[0]) + "(" + str(total_cavity_permanent_molar[0]) + "%)",
                str(cavity_permanent_molar_number[1]) + "(" + str(total_cavity_permanent_molar[1]) + "%)",
            ...
            final_total_cavity_permanent_anterior = [
                "Cavity permanent anterior" ,
                str(cavity_permanent_anterior_number[0]) + "(" + str(total_cavity_permanent_anterior[0]) + "%)",
                str(cavity_permanent_anterior_number[1]) + "(" + str(total_cavity_permanent_anterior[1]) + "%)",
            ...
            final_total_active_infection = [
                "Active Infection" ,
                str(active_infection_number[0]) + "(" + str(total_active_infection[0]) + "%)",
                str(active_infection_number[1]) + "(" + str(total_active_infection[1]) + "%)",
            ...
            final_total_reversible_pulpitis = [
                "Mouth pain due to reversible pulpitis" ,
                str(reversible_pulpitis_number[0]) + "(" + str(total_reversible_pulpitis[0]) + "%)",
                str(reversible_pulpitis_number[1]) + "(" + str(total_reversible_pulpitis[1]) + "%)",
            ...
            final_total_need_art_filling = [
                "Need ART filling" ,
                str(need_art_filling_number[0]) + "(" + str(total_need_art_filling[0]) + "%)",
                str(need_art_filling_number[1]) + "(" + str(total_need_art_filling[1]) + "%)",
            ...
            final_total_need_sdf = [
                "Need SDF" ,
                str(need_sdf_number[0]) + "(" + str(total_need_sdf[0]) + "%)",
                str(need_sdf_number[1]) + "(" + str(total_need_sdf[1]) + "%)",
                total_need_sdf[2],
                total_need_sdf[3],
                total_need_sdf[4],
                total_need_sdf[5],
            ...
            final_total_need_extraction = [
                "Need Extraction" ,
                str(need_extraction_number[0]) + "(" + str(total_need_extraction[0]) + "%)",
                str(need_extraction_number[1]) + "(" + str(total_need_extraction[1]) + "%)",
            ...
            final_total_need_fv = [
                "Need FV" ,
                str(need_fv_number[0]) + "(" + str(total_need_fv[0]) + "%)",
                str(need_fv_number[1]) + "(" + str(total_need_fv[1]) + "%)",
                total_need_fv[2],
                total_need_fv[3],
                total_need_fv[4],
                total_need_fv[5],
            ...
            final_total_need_dentist_or_hygienist = [
                ...
                str(need_dentist_or_hygienist_number[0]) + "(" + str(total_need_dentist_or_hygienist[0]) + "%)",
                str(need_dentist_or_hygienist_number[1]) + "(" + str(total_need_dentist_or_hygienist[1]) + "%)",
