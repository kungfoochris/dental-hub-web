    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if location == "All Location":
                total_encounter = Visualization.objects.filter(created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_exo = Visualization.objects.filter(exo=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_art = Visualization.objects.filter(art=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_seal = Visualization.objects.filter(seal=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_sdf = Visualization.objects.filter(sdf=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                total_health_post = Visualization.objects.filter(refer_hp=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_refer_hyg = Visualization.objects.filter(refer_hyg=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_refer_dent = Visualization.objects.filter(refer_dent=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_refer_dr = Visualization.objects.filter(refer_dr=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_refer_other = Visualization.objects.filter(refer_other=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                total_sdf_whole_mouth = Visualization.objects.filter(sdf_whole_mouth=True,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_encounter = Visualization.objects.filter(age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_encounter_male = Visualization.objects.filter(age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_encounter_female = Visualization.objects.filter(age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_exo = Visualization.objects.filter(exo=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_exo_male = Visualization.objects.filter(exo=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_exo_female = Visualization.objects.filter(exo=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_art = Visualization.objects.filter(art=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_art_male = Visualization.objects.filter(art=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_art_female = Visualization.objects.filter(art=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_seal = Visualization.objects.filter(seal=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_seal_male = Visualization.objects.filter(seal=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_seal_female = Visualization.objects.filter(seal=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_sdf = Visualization.objects.filter(sdf=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_sdf_male = Visualization.objects.filter(sdf=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_sdf_female = Visualization.objects.filter(sdf=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_fv = Visualization.objects.filter(fv=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_fv_male = Visualization.objects.filter(fv=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_fv_female = Visualization.objects.filter(fv=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_health_post = Visualization.objects.filter(refer_hp=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_health_post_male = Visualization.objects.filter(refer_hp=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_health_post_female = Visualization.objects.filter(refer_hp=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_refer_hyg = Visualization.objects.filter(refer_hyg=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_hyg_male = Visualization.objects.filter(refer_hyg=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_hyg_female = Visualization.objects.filter(refer_hyg=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_refer_dent = Visualization.objects.filter(refer_dent=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_dent_male = Visualization.objects.filter(refer_dent=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_dent_female = Visualization.objects.filter(refer_dent=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_refer_dr = Visualization.objects.filter(refer_dr=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_dr_male = Visualization.objects.filter(refer_dr=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_dr_female = Visualization.objects.filter(refer_dr=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_refer_other = Visualization.objects.filter(refer_other=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_other_male = Visualization.objects.filter(refer_other=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_refer_other_female = Visualization.objects.filter(refer_other=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                kid_sdf_whole_mouth = Visualization.objects.filter(sdf_whole_mouth=True,age__lt=18,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_sdf_whole_mouth_male = Visualization.objects.filter(sdf_whole_mouth=True,age__lt=18,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                kid_sdf_whole_mouth_female = Visualization.objects.filter(sdf_whole_mouth=True,age__lt=18,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_encounter = Visualization.objects.filter(age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_encounter_male = Visualization.objects.filter(age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_encounter_female = Visualization.objects.filter(age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_exo = Visualization.objects.filter(exo=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_exo_male = Visualization.objects.filter(exo=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_exo_female = Visualization.objects.filter(exo=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_art = Visualization.objects.filter(art=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_art_male = Visualization.objects.filter(art=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_art_female = Visualization.objects.filter(art=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_seal = Visualization.objects.filter(seal=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_seal_male = Visualization.objects.filter(seal=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_seal_female = Visualization.objects.filter(seal=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_sdf = Visualization.objects.filter(sdf=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_sdf_male = Visualization.objects.filter(sdf=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_sdf_female = Visualization.objects.filter(sdf=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_fv = Visualization.objects.filter(fv=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_fv_male = Visualization.objects.filter(fv=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_fv_female = Visualization.objects.filter(fv=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_health_post = Visualization.objects.filter(refer_hp=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_health_post_male = Visualization.objects.filter(refer_hp=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_health_post_female = Visualization.objects.filter(refer_hp=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_refer_hyg = Visualization.objects.filter(refer_hyg=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_hyg_male = Visualization.objects.filter(refer_hyg=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_hyg_female = Visualization.objects.filter(refer_hyg=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_refer_dent = Visualization.objects.filter(refer_dent=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_dent_male = Visualization.objects.filter(refer_dent=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_dent_female = Visualization.objects.filter(refer_dent=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_refer_dr = Visualization.objects.filter(refer_dr=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_dr_male = Visualization.objects.filter(refer_dr=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_dr_female = Visualization.objects.filter(refer_dr=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_refer_other = Visualization.objects.filter(refer_other=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_other_male = Visualization.objects.filter(refer_other=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_refer_other_female = Visualization.objects.filter(refer_other=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                adult_sdf_whole_mouth = Visualization.objects.filter(sdf_whole_mouth=True,age__range=(18,60),created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_sdf_whole_mouth_male = Visualization.objects.filter(sdf_whole_mouth=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                adult_sdf_whole_mouth_female = Visualization.objects.filter(sdf_whole_mouth=True,age__range=(18,60),created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()


                old_encounter = Visualization.objects.filter(age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_encounter_male = Visualization.objects.filter(age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_encounter_female = Visualization.objects.filter(age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_exo = Visualization.objects.filter(exo=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_exo_male = Visualization.objects.filter(exo=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_exo_female = Visualization.objects.filter(exo=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_art = Visualization.objects.filter(art=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_art_male = Visualization.objects.filter(art=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_art_female = Visualization.objects.filter(art=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_seal = Visualization.objects.filter(seal=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_seal_male = Visualization.objects.filter(seal=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_seal_female = Visualization.objects.filter(seal=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_sdf = Visualization.objects.filter(sdf=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_sdf_male = Visualization.objects.filter(sdf=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_sdf_female = Visualization.objects.filter(sdf=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_fv = Visualization.objects.filter(fv=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_fv_male = Visualization.objects.filter(fv=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_fv_female = Visualization.objects.filter(fv=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_health_post = Visualization.objects.filter(refer_hp=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_health_post_male = Visualization.objects.filter(refer_hp=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_health_post_female = Visualization.objects.filter(refer_hp=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_refer_hyg = Visualization.objects.filter(refer_hyg=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_hyg_male = Visualization.objects.filter(refer_hyg=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_hyg_female = Visualization.objects.filter(refer_hyg=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_refer_dent = Visualization.objects.filter(refer_dent=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_dent_male = Visualization.objects.filter(refer_dent=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_dent_female = Visualization.objects.filter(refer_dent=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_refer_dr = Visualization.objects.filter(refer_dr=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_dr_male = Visualization.objects.filter(refer_dr=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_dr_female = Visualization.objects.filter(refer_dr=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_refer_other = Visualization.objects.filter(refer_other=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_other_male = Visualization.objects.filter(refer_other=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_refer_other_female = Visualization.objects.filter(refer_other=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()

                old_sdf_whole_mouth = Visualization.objects.filter(sdf_whole_mouth=True,age__gt=60,created_at__range=[start_date,end_date]).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_sdf_whole_mouth_male = Visualization.objects.filter(sdf_whole_mouth=True,age__gt=60,created_at__range=[start_date,end_date],gender="male").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                old_sdf_whole_mouth_female = Visualization.objects.filter(sdf_whole_mouth=True,age__gt=60,created_at__range=[start_date,end_date],gender="female").filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
            else:
                ...
                kid_encounter = Visualization.objects.filter(age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_exo = Visualization.objects.filter(exo=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_art = Visualization.objects.filter(art=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_seal = Visualization.objects.filter(seal=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_sdf = Visualization.objects.filter(sdf=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_fv = Visualization.objects.filter(fv=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_health_post = Visualization.objects.filter(refer_hp=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_refer_hyg = Visualization.objects.filter(refer_hyg=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_refer_dent = Visualization.objects.filter(refer_dent=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_refer_dr = Visualization.objects.filter(refer_dr=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_refer_other = Visualization.objects.filter(refer_other=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                kid_sdf_whole_mouth = Visualization.objects.filter(sdf_whole_mouth=True,age__lt=18,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_encounter = Visualization.objects.filter(age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_exo = Visualization.objects.filter(exo=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_art = Visualization.objects.filter(art=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_seal = Visualization.objects.filter(seal=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_sdf = Visualization.objects.filter(sdf=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_fv = Visualization.objects.filter(fv=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_health_post = Visualization.objects.filter(refer_hp=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_refer_hyg = Visualization.objects.filter(refer_hyg=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_refer_dent = Visualization.objects.filter(refer_dent=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_refer_dr = Visualization.objects.filter(refer_dr=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_refer_other = Visualization.objects.filter(refer_other=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                adult_sdf_whole_mouth = Visualization.objects.filter(sdf_whole_mouth=True,age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_encounter = Visualization.objects.filter(age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_exo = Visualization.objects.filter(exo=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_art = Visualization.objects.filter(art=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_seal = Visualization.objects.filter(seal=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_sdf = Visualization.objects.filter(sdf=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_fv = Visualization.objects.filter(fv=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_health_post = Visualization.objects.filter(refer_hp=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_refer_hyg = Visualization.objects.filter(refer_hyg=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_refer_dent = Visualization.objects.filter(refer_dent=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_refer_dr = Visualization.objects.filter(refer_dr=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_refer_other = Visualization.objects.filter(refer_other=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
                ...
                old_sdf_whole_mouth = Visualization.objects.filter(sdf_whole_mouth=True,age__gt=60,created_at__range=[start_date,end_date],geography_id=location).filter(Q(activities_id=health_post)|Q(activities_id=seminar)|Q(activities_id=outreach)|Q(activities_id=outreach)).count()
