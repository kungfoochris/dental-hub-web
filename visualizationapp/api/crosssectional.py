...
# round(sdf_real_difference/total_need_sdf[0],2)
            ...
            final_total_decayed_primary_teeth = [
                ["Number of decayed primary teeth" ,""],
                [decayed_primary_teeth_mean_list_ABC[0],"(" + str(total_decayed_primary_teeth[0]) + "%)"],
                [decayed_primary_teeth_mean_list_ABC[1],"(" + str(total_decayed_primary_teeth[1]) + "%)"],
                [decayed_primary_teeth_mean_list_ABC[2],"(" + str(total_decayed_primary_teeth[2]) + "%)"],
                [total_decayed_primary_teeth[3],""],
                [decayed_primary_teeth_mean_list_EFGH[0],"(" + str(total_decayed_primary_teeth[4]) + "%)"],
                [decayed_primary_teeth_mean_list_EFGH[1],"(" + str(total_decayed_primary_teeth[5]) + "%)"],
                [decayed_primary_teeth_mean_list_EFGH[2],"(" + str(total_decayed_primary_teeth[6]) + "%)"],
                [decayed_primary_teeth_mean_list_EFGH[3],"(" + str(total_decayed_primary_teeth[7]) + "%)"],
                [total_decayed_primary_teeth[8],""],
                [total_decayed_primary_teeth[9],""],
                ]
            
            final_total_decayed_permanent_teeth = [
                ["Number of decayed permanent teeth" ,""],
                [decayed_permanent_teeth_list_ABC[0],"(" + str(total_decayed_permanent_teeth[0]) + "%)"],
                [decayed_permanent_teeth_list_ABC[1],"(" + str(total_decayed_permanent_teeth[1]) + "%)"],
                [decayed_permanent_teeth_list_ABC[2],"(" + str(total_decayed_permanent_teeth[2]) + "%)"],
                [total_decayed_permanent_teeth[3],""],
                [decayed_permanent_teeth_list_EFGH[0],"(" + str(total_decayed_permanent_teeth[4]) + "%)"],
                [decayed_permanent_teeth_list_EFGH[1],"(" + str(total_decayed_permanent_teeth[5]) + "%)"],
                [decayed_permanent_teeth_list_EFGH[2],"(" + str(total_decayed_permanent_teeth[6]) + "%)"],
                [decayed_permanent_teeth_list_EFGH[3],"(" + str(total_decayed_permanent_teeth[7]) + "%)"],
                [total_decayed_permanent_teeth[8],""],
                [total_decayed_permanent_teeth[9],""],
                ]
            ...
            final_total_untreated_caries_present = [
                ...
                [total_untreated_caries_present[9],""],
                ]
            ...
            final_total_cavity_permanent_molar = [
                ...
                [total_cavity_permanent_molar[9],""],
                ]
            ...
            final_total_cavity_permanent_anterior = [
                ...
                [total_cavity_permanent_anterior[9],""],
                ]
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if User.objects.filter(id=request.user.id).exists():
                ...
                final_total_decayed_primary_teeth = [
                    ["Number of decayed primary teeth" ,""],
                    [decayed_primary_teeth_mean_list_ABC[0],"(" + "SD" + str(total_decayed_primary_teeth[0]) + ")"],
                    [decayed_primary_teeth_mean_list_ABC[1],"(" + "SD" + str(total_decayed_primary_teeth[1]) + ")"],
                    [decayed_primary_teeth_mean_list_ABC[2],"(" + "SD" + str(total_decayed_primary_teeth[2]) + ")"],
                    [total_decayed_primary_teeth[3],""],
                    [decayed_primary_teeth_mean_list_EFGH[0],"(" + "SD" + str(total_decayed_primary_teeth[4]) + ")"],
                    [decayed_primary_teeth_mean_list_EFGH[1],"(" + "SD" + str(total_decayed_primary_teeth[5]) + ")"],
                    [decayed_primary_teeth_mean_list_EFGH[2],"(" + "SD" + str(total_decayed_primary_teeth[6]) + ")"],
                    [decayed_primary_teeth_mean_list_EFGH[3],"(" + "SD" + str(total_decayed_primary_teeth[7]) + ")"],
                    [total_decayed_primary_teeth[8],""],
                    [total_decayed_primary_teeth[9],""],
                    ]
                ...
                final_total_decayed_permanent_teeth = [
                    ["Number of decayed permanent teeth" ,""],
                    [decayed_permanent_teeth_mean_list_ABC[0],"(" + "SD" + str(total_decayed_permanent_teeth[0]) + ")"],
                    [decayed_permanent_teeth_mean_list_ABC[1],"(" + "SD" + str(total_decayed_permanent_teeth[1]) + ")"],
                    [decayed_permanent_teeth_mean_list_ABC[2],"(" + "SD" + str(total_decayed_permanent_teeth[2]) + ")"],
                    [total_decayed_permanent_teeth[3],""],
                    [decayed_permanent_teeth_mean_list_EFGH[0],"(" + "SD" + str(total_decayed_permanent_teeth[4]) + ")"],
                    [decayed_permanent_teeth_mean_list_EFGH[1],"(" + "SD" + str(total_decayed_permanent_teeth[5]) + ")"],
                    [decayed_permanent_teeth_mean_list_EFGH[2],"(" + "SD" + str(total_decayed_permanent_teeth[6]) + ")"],
                    [decayed_permanent_teeth_mean_list_EFGH[3],"(" + "SD" + str(total_decayed_permanent_teeth[7]) + ")"],
                    [total_decayed_permanent_teeth[8],""],
                    [total_decayed_permanent_teeth[9],""],
                    ]
