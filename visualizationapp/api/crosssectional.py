...
class SectionalVisualization(APIView):
    ...
    def post(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            total_active_infection_6=Visualization.objects.filter(age=6,active_infection=True,created_at__range=[start_date,end_date],geography_id=location).count()
            total_active_infection_12=Visualization.objects.filter(age=12,active_infection=True,created_at__range=[start_date,end_date],geography_id=location).count()
            total_active_infection_15=Visualization.objects.filter(age=15,active_infection=True,created_at__range=[start_date,end_date],geography_id=location).count()
            total_active_infection_child=Visualization.objects.filter(age__lt=18,active_infection=True,created_at__range=[start_date,end_date],geography_id=location).count()
            total_active_infection_adult=Visualization.objects.filter(age__range=(18,60),active_infection=True,created_at__range=[start_date,end_date],geography_id=location).count()
            total_active_infection_old=Visualization.objects.filter(age__gt=60,active_infection=True,created_at__range=[start_date,end_date],geography_id=location).count()

            carries_risk_low.append(Visualization.objects.filter(age=6,carries_risk="Low",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_low.append(Visualization.objects.filter(age=12,carries_risk="Low",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_low.append(Visualization.objects.filter(age=15,carries_risk="Low",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_low.append(Visualization.objects.filter(age__lt=18,carries_risk="Low",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_low.append(Visualization.objects.filter(age__range=(18,60),carries_risk="Low",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_low.append(Visualization.objects.filter(age__gt=60,carries_risk="Low",created_at__range=[start_date,end_date],geography_id=location).count())

            carries_risk_medium.append(Visualization.objects.filter(age=6,carries_risk="Medium",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_medium.append(Visualization.objects.filter(age=12,carries_risk="Medium",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_medium.append(Visualization.objects.filter(age=15,carries_risk="Medium",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_medium.append(Visualization.objects.filter(age__lt=18,carries_risk="Medium",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_medium.append(Visualization.objects.filter(age__range=(18,60),carries_risk="Medium",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_medium.append(Visualization.objects.filter(age__gt=60,carries_risk="Medium",created_at__range=[start_date,end_date],geography_id=location).count())

            carries_risk_high.append(Visualization.objects.filter(age=6,carries_risk="High",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_high.append(Visualization.objects.filter(age=12,carries_risk="High",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_high.append(Visualization.objects.filter(age=15,carries_risk="High",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_high.append(Visualization.objects.filter(age__lt=18,carries_risk="High",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_high.append(Visualization.objects.filter(age__range=(18,60),carries_risk="High",created_at__range=[start_date,end_date],geography_id=location).count())
            carries_risk_high.append(Visualization.objects.filter(age__gt=60,carries_risk="High",created_at__range=[start_date,end_date],geography_id=location).count())

            decayed_primary_teeth_6=[]
            permanent_molar_teeth_6=[]
            for i in Visualization.objects.filter(age=6,created_at__range=[start_date,end_date],geography_id=location):
                decayed_primary_teeth_6.append(i.decayed_primary_teeth_number)
                permanent_molar_teeth_6.append(i.decayed_permanent_teeth_number)
            ...
            decayed_primary_teeth_12=[]
            permanent_molar_teeth_12=[]
            for i in Visualization.objects.filter(age=12,created_at__range=[start_date,end_date],geography_id=location):
                decayed_primary_teeth_12.append(i.decayed_primary_teeth_number)
                permanent_molar_teeth_12.append(i.decayed_permanent_teeth_number)
            ...
            decayed_primary_teeth_15=[]
            permanent_molar_teeth_15=[]
            for i in Visualization.objects.filter(age=15,created_at__range=[start_date,end_date],geography_id=location):
                decayed_primary_teeth_15.append(i.decayed_primary_teeth_number)
                decayed_primary_teeth_15.append(i.decayed_permanent_teeth_number)
            ...
            decayed_primary_teeth_child=[]
            permanent_molar_teeth_child=[]
            for i in Visualization.objects.filter(age__lt=18,created_at__range=[start_date,end_date],geography_id=location):
                decayed_primary_teeth_child.append(i.decayed_primary_teeth_number)
                permanent_molar_teeth_child.append(i.decayed_permanent_teeth_number)
            ...
            decayed_primary_teeth_adult=[]
            permanent_molar_teeth_adult=[]
            for i in Visualization.objects.filter(age__range=(18,60),created_at__range=[start_date,end_date],geography_id=location):
                decayed_primary_teeth_adult.append(i.decayed_primary_teeth_number)
                permanent_molar_teeth_adult.append(i.decayed_permanent_teeth_number)
            ...
            decayed_primary_teeth_old=[]
            permanent_molar_teeth_old=[]
            for i in Visualization.objects.filter(age__gt=60,created_at__range=[start_date,end_date],geography_id=location):
                decayed_primary_teeth_old.append(i.decayed_primary_teeth_number)
                permanent_molar_teeth_old.append(i.decayed_permanent_teeth_number)
