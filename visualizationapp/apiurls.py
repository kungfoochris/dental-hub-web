...
from visualizationapp.api.crosssectional import SectionalVisualization,TestCrossSectionalVisualization
...
urlpatterns = [
	...
	path('testcrosssectional',TestCrossSectionalVisualization.as_view()),
