...
def seed(request):
    try:
        User.objects.create(
            username="Jevaia",
            email="dentalhub@jevaia.org",
            password="Jevaia12345",
            first_name="dental",
            last_name="hub",
            admin=True,
            staff=True,
        ...
        User.objects.create(
            username="abhiyantrik",
            email="prabin@abhiyantrik.com",
            password="dental123",
            first_name="admin",
            last_name="user",
            admin=True,
        ...
        for data_obj in data:
            ...
            for muncipality_obj in data_obj["municipalities"]:
                muncipality_obj1 = Municipality.objects.create(
                    district=district_obj1,
                    name=muncipality_obj["name"].capitalize(),
                    category=muncipality_obj["type"],
                )
