# Generated by Django 2.0 on 2019-09-23 04:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geography', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encounter_geography', to='addressapp.Geography')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('epilepsy_or_seizures', models.BooleanField(default=False, verbose_name='epilepsy or seizures')),
                ...
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='update_history', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Refer',
            fields=[
                ...
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='update_refer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Screeing',
            fields=[
                ...
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='update_screeing', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
